        ...
        <div className='row'>
          <div className='col-lg-3 col-sm-6'>
            <div className='single-categories-box hover-active'>
              <img
                src='../images/categories/furniture-category1.jpg'
                alt='image'
              />
          ...
          <div className='col-lg-3 col-sm-6'>
            <div className='single-categories-box hover-active'>
              <img
                src='../images/categories/furniture-category2.jpg'
                alt='image'
              />
          ...
          <div className='col-lg-3 col-sm-6'>
            <div className='single-categories-box hover-active'>
              <img
                src='../images/categories/furniture-category3.jpg'
                alt='image'
              />
          ...
          <div className='col-lg-3 col-sm-6'>
            <div className='single-categories-box hover-active'>
              <img
                src='../images/categories/furniture-category4.jpg'
                alt='image'
              />
