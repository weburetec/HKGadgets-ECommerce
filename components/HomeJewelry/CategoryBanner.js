        ...
        <div className='row'>
          <div className='col-lg-3 col-sm-6'>
            <div className='single-categories-box left-categories hover-active'>
              <img
                src='../images/categories/jewelry-category1.jpg'
                alt='image'
              />
          ...
          <div className='col-lg-3 col-sm-6'>
            <div className='single-categories-box left-categories hover-active overly'>
              <img
                src='../images/categories/jewelry-category2.jpg'
                alt='image'
              />
          ...
          <div className='col-lg-3 col-sm-6'>
            <div className='single-categories-box left-categories hover-active overly'>
              <img
                src='../images/categories/jewelry-category3.jpg'
                alt='image'
              />
          ...
          <div className='col-lg-3 col-sm-6'>
            <div className='single-categories-box left-categories hover-active'>
              <img
                src='../images/categories/jewelry-category4.jpg'
                alt='image'
              />
